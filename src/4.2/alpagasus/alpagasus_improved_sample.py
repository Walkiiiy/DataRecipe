#!/usr/bin/env python3
"""Selection for alpagasus_improved (capability-vector greedy)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Select data by alpagasus_improved vector score (greedy).")
