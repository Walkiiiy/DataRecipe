#!/usr/bin/env python3
"""Selection for SRM outputs (capability-vector greedy)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Select data by SRM mapped_vector score (greedy).")
    parser.add_argument("--score_path", type=str, required=True, help="SRM score file path.")
    parser.add_argument(
        "--data_path",
        type=str,
        default=None,
        help="Optional raw data path for id-based restore (recommended for SRM outputs).",
    )
