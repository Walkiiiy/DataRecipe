#!/usr/bin/env python3
"""Selection for delta_origin (scalar top-k via delta_scalar)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Select data by delta_origin scalar score (top-k).")
    parser.add_argument("--score_path", type=str, required=True, help="Scored rows path.")
    parser.add_argument("--data_path", type=str, default=None, help="Optional raw data path for id-based restore.")
...
def main() -> None:
    ...
    run_selection(
        ...
        strategy="scalar_topk",
        id_field=args.id_field,
        scalar_field="delta_scalar",
