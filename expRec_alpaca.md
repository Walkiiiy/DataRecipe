...
python3 src/scripts/split_train_test_random.py \
  --train-jsonl data/alpaca/train.jsonl


# 能力树
- 重构4.1为模型聚类
- python3 /home/walkiiiy/DataRecipe/src/4.1/llm_capability_tree_builder.py \
  --input-jsonl /home/walkiiiy/DataRecipe/data/alpaca/train.jsonl \
...
python3 src/4.2/stage_2_top_k_routing.py \
  --dataset_path data/alpaca/train.jsonl \
  --centroids_path data/alpaca/capability_tree_final.json \
  --centroid_source auto \
  --model_name auto \
  --top_k 5 \
  --output_path data/alpaca/train_coarse_topk5.jsonl \
  --output_centroid_manifest data/alpaca/centroid_manifest.json
...
- python3 src/4.2/SRM/SRM.py \
  --input_path data/alpaca/train_coarse_topk5.jsonl \
  --data_path data/alpaca/train.jsonl \
  --api_key "sk-ab412f420cd540888da4732a35600c4a" \
  --output_path data/alpaca/score/srm_from_topk5_only.jsonl \
...
python3 /home/walkiiiy/DataRecipe/src/4.2/SRM/srm_sample.py \
  --score_path /home/walkiiiy/DataRecipe/data/alpaca/score/srm_from_topk5_only.jsonl \
  --data_path /home/walkiiiy/DataRecipe/data/alpaca/train.jsonl \
  --output_path /home/walkiiiy/DataRecipe/data/alpaca/exp4.2/dataset_srm_1000.jsonl \
  --num_samples 1000
...
python3 src/4.2/delta/delta_improved.py \
  --data_path data/alpaca/train.jsonl \
  --routing_path data/alpaca/train_coarse_topk5.jsonl \
  --output_path data/alpaca/score/delta_improved_mapped.jsonl \
  --concurrency 16 \
  --quality_mode batch \
  --cluster_batch_size 5

python3 /home/walkiiiy/DataRecipe/src/4.2/delta/delta_improved_sample.py \
  --score_path /home/walkiiiy/DataRecipe/data/alpaca/score/delta_improved_mapped.jsonl \
  --data_path /home/walkiiiy/DataRecipe/data/alpaca/train.jsonl \
  --output_path /home/walkiiiy/DataRecipe/data/alpaca/exp4.2/dataset_delta_improved_1000.jsonl \
  --num_samples 1000
...
python3 src/4.2/delta/delta_origin.py \
  --data_path data/alpaca/train.jsonl \
  --routing_path data/alpaca/train_coarse_topk5.jsonl \
  --output_path data/alpaca/score/delta_origin_mapped.jsonl \
  --concurrency 16 \
  --turn_aggregation sum \
  --routing_weight_mode coarse

python3 /home/walkiiiy/DataRecipe/src/4.2/delta/delta_origin_sample.py \
  --score_path /home/walkiiiy/DataRecipe/data/alpaca/score/delta_origin_mapped.jsonl \
  --data_path /home/walkiiiy/DataRecipe/data/alpaca/train.jsonl \
  --output_path /home/walkiiiy/DataRecipe/data/alpaca/exp4.2/dataset_delta_origin_1000.jsonl \
  --num_samples 1000
...
python3 src/4.2/alpagasus/alpagasus_origin.py \
  --data_path data/alpaca/train.jsonl \
  --output_path data/alpaca/score/alpagasus_origin_scored.jsonl \
  --model deepseek-chat \
...
python3 /home/walkiiiy/DataRecipe/src/4.2/alpagasus/alpagasus_origin_sample.py \
  --score_path /home/walkiiiy/DataRecipe/data/alpaca/score/alpagasus_origin_scored.jsonl \
  --data_path /home/walkiiiy/DataRecipe/data/alpaca/train.jsonl \
  --output_path /home/walkiiiy/DataRecipe/data/alpaca/exp4.2/dataset_alpagasus_origin_1000.jsonl \
  --num_samples 1000
...
python3 src/4.2/instag/instag.py \
  --data_path data/alpaca/train.jsonl \
  --output_path data/alpaca/score/instag_tags.jsonl \
  --model deepseek-chat \
  --concurrency 16
...
python src/scripts/sample_train_subset.py \
  ...
  --output-jsonl data/alpaca/exp4.2/dataset_random_1000.jsonl \
  --sample-size 1000 \
  --seed 42
...
python src/4.1/EXP/sft_lora_train_shared_eval.py \
  --run delta_origin::data/alpaca/exp4.2/dataset_delta_origin_1000.jsonl::data/alpaca/exp4.2/run_delta_origin_1000_shared_eval \
  --eval-source-jsonl data/alpaca/test.jsonl \
  --eval-ratio 1 \
  --seed 42 \
  --num_train_epochs 4 \
  ...
  --run srm::data/alpaca/exp4.2/dataset_srm_1000.jsonl::data/alpaca/exp4.2/run_srm_1000_shared_eval \
  --run random::data/alpaca/exp4.2/dataset_random_1000.jsonl::data/alpaca/exp4.2/run_random_1000_shared_eval \

  --run delta_improved::data/alpaca/exp4.2/dataset_delta_improved_1000.jsonl::data/alpaca/exp4.2/run_delta_improved_1000_shared_eval \
  --run alpagasus_origin::data/alpaca/exp4.2/dataset_alpagasus_origin_1000.jsonl::data/alpaca/exp4.2/run_alpagasus_origin_1000_shared_eval \
...
python src/4.1/EXP/eval_checkpoints_em.py \
  ...
  --run delta_origin::data/alpaca/exp4.2/run_delta_origin_1000_shared_eval/final_checkpoint \


  --run random::data/alpaca/exp4.2/run_random_1000_shared_eval/final_checkpoint \
  --run srm::data/alpaca/exp4.2/run_srm_1000_shared_eval/final_checkpoint



  --run alpagasus_origin::data/alpaca/exp4.2/run_alpagasus_origin_1000_shared_eval/final_checkpoint 



  --run delta_improved::data/alpaca/exp4.2/run_delta_improved_1000_shared_eval/final_checkpoint \

  run_delta_origin_1000_shared_eval/final_checkpoint \
  --run alpagasus_origin::data/alpaca/exp4.2/
  run_alpagasus_origin_1000_shared_eval/final_checkpoint \
  --output-dir data/alpaca/exp4.2/em_eval
...
python src/4.1/EXP/eval_checkpoints_bertscore.py \
  ...
  --run srm::data/alpaca/exp4.2/run_srm_1000_shared_eval/final_checkpoint \
  --run random::data/alpaca/exp4.2/run_random_1000_shared_eval/final_checkpoint \
  --output-dir data/alpaca/exp4.2/bertscore_eval \
  --save-per-run-jsonl
