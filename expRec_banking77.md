...
- python3 /home/walkiiiy/DataRecipe/src/4.1/llm_capability_tree_builder.py \
  --input-jsonl /home/walkiiiy/DataRecipe/data/banking77/train.jsonl \
...
python3 src/4.2/stage_2_top_k_routing.py \
  ...
  --centroids_path data/banking77/capability_tree_final.json \
  --centroid_source auto \
  --model_name auto \
  --top_k 5 \
  --output_path data/banking77/train_coarse_topk5.jsonl \
  --output_centroid_manifest data/banking77/centroid_manifest.json
...
- python3 src/4.2/SRM/SRM.py \
  --input_path data/banking77/train_coarse_topk5.jsonl \
  --data_path data/banking77/train.jsonl \
  --api_key "sk-ab412f420cd540888da4732a35600c4a" \
  --output_path data/banking77/score/srm_from_topk5_only.jsonl \
...
python src/4.1/EXP/eval_checkpoints_em.py \
  ...
  --run kmeans::data/banking77/exp4.2/run_kmeans_shared_eval/final_checkpoint \
  --run kmeans::data/banking77/exp4.2/run_kmeans_shared_eval/final_checkpoint \
